# Writing Style — Concept Cards

Purpose
- Shapes Summary and Full Description for Concept cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences defining the concept and current relevance.
- Full Description: 3–8 sentences covering definition, mechanism/process, tell‑tale signs, spread, impacts, and limits.
...
Coverage
- Clear definition and governing rules.
- Mechanisms, signals, triggers, and typical outcomes.
- Known scope or rates; impacts on factions, places, and travelers.

Canon and safety
- Link related pages via fields; do not summarize those pages here.
