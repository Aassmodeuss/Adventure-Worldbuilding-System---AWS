# Writing Style — Region Cards

Purpose
- Shapes Summary and Full Description for Place: Region cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences on identity and role within the realm.
- Full Description: 3–8 sentences on terrain patterns, dominant biomes, key routes, resources, and recurring hazards; avoid listing specific settlements.
...
Coverage (delta to realm)
- Geographical boundaries and travel corridors.
- Resource profiles and economic activities at regional scale.
- Recurring environmental hazards and patrol/mitigation norms.
- High‑level presence of factions or species without enumerating towns or tribes.
