# Writing Style — Place Concept Cards

Purpose
- Shapes Summary and Full Description for Place Concept cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences defining the concept and scope.
- Full Description: 3–8 sentences on how the concept works in practice, typical impacts, and representative forms.
...
Coverage
- Definition and rules that govern the concept.
- Common manifestations and where they are encountered.
- Operational limits or exceptions; how it interacts with travel, economy, or magic.
