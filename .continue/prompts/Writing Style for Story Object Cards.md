# Writing Style — Story Object Cards

Purpose
- Shapes Summary and Full Description for Object: Story cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences stating what the object is, why it exists, and current relevance.
- Full Description: 5–12 sentences on origin, construction, operation, control/stewardship, historical phases, current status, and risks/limits.
...
Coverage
- Purpose and mechanism; stewardship and access/control.
- Notable operational phases or incidents; present status and constraints.
- Quantify scale, throughput, cadence, and operating windows when known.
