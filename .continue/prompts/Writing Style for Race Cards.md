# Writing Style — Race Cards

Purpose
- Shapes Summary and Full Description for Beings: Race cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences naming identity, signature traits, and distribution.
- Full Description: 3–8 sentences on physiology, senses, psychology, culture, home regions/diaspora, adaptations, and limits.
...
Coverage
- Distinct physiological/sensory traits that shape behavior.
- Cultural patterns and social organization (concise, representative).
- Geographic spread and primary regions (evidence‑based).
- Adaptations and limits; interactions with magic/corruption if established.

Canon and safety
- Do not restate specific location/faction lore; focus on species‑level patterns only.
