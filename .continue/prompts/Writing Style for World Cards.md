# Writing Style — World Cards

Purpose
- Shapes Summary and Full Description for Place: World cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences naming the world and its defining significance (note parallel worlds if relevant).
- Full Description: 3–8 sentences on continents/realms, macro travel constraints, cosmology, eras, and overarching forces; no local peoples or settlements.
...
Coverage
- Macro geography and realm relationships.
- Global routes, barriers, and traversal methods.
- Cosmological context and epochal forces that shape the setting.
- High‑level risks or phenomena that affect all realms.
