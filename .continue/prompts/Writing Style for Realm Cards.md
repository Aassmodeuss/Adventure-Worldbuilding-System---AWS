# Writing Style — Realm Cards

Purpose
- Shapes Summary and Full Description for Place: Realm cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences on identity and realm‑level role in the world.
- Full Description: 3–8 sentences on climate bands, major routes, peoples at a high level, resources, and recurring hazards; avoid listing specific tribes or settlements.
...
Coverage (delta to world)
- Geopolitical posture and relations to adjacent realms (high‑level).
- Trade arteries, chokepoints, and traversal constraints.
- Resource pillars and strategic risks.
- Major cultural forces present without enumerating subgroups.
