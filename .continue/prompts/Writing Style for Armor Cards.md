# Writing Style — Armor Cards

Purpose
- Shapes Summary and Full Description for Object: Armor cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences stating what the armor is and its purpose.
- Full Description: 3–8 sentences on construction, layers/systems, protection types, maintenance/power, and limits/failure modes.
...
Coverage
- Armor class and materials; coverage and fit.
- Protection profile against kinetic, environmental, and magical/corruptive threats (if applicable).
- Power/maintenance needs and tradeoffs (weight, mobility, recharge) with quantified ranges when known.
- Typical makers/users and regulation context (brief).
