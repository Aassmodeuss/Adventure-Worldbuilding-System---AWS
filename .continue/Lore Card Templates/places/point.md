# Template - Place: Point

Purpose
- Use for specific rooms, features, or micro-sites within a location.
- Provide focused, functional details only.

Frontmatter
```yaml
---
id: point:council-chambers
type: point
name: Council Chambers
parent: location:verdant-hall
see_also: []
---
```
...
Pre-save checklist
- Parent points to its location.  
- No Locations of Note.  
- Tight, functional prose.
