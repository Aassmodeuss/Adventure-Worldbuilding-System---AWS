# Template - Place: Realm

Purpose
- Use for primary geographic realms within a world (e.g., Greenwood, The Rootlands).
- Define major identity and movement patterns. Avoid region or local specifics.
...
Pre-save checklist
- Parent points to its world.  
- Locations of Note list only regions.  
- No local inhabitants listed at this level.
