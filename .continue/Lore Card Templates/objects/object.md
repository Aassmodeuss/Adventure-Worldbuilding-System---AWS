...
Purpose
- Use for non-armor objects such as tools, consumables, devices, artifacts, and kits.
- Describe composition, mechanism of action, use cases, limits, and handling/storage.
...
**Function and Mechanism:** how it works at a practical level  
**Activation/Use:** steps or conditions to operate/apply  
**Maintenance/Storage:** upkeep, handling, shelf life, charging  
...
Pre-save checklist
- Object Type, Composition/Materials, and Function/Mechanism populated.  
- Maintenance/Storage and Safety/Regulation note concrete costs/limits.  
