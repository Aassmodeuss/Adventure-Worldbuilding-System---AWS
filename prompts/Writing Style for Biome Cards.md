# Writing Style — Biome Cards

Purpose
- Shapes Summary and Full Description for Place: Biome cards. Consumed by `tools/cardgen.ps1` (script/API).

Output scope
- Summary: 1–2 sentences naming identity and primary survival constraints.
- Full Description: 3–8 sentences on ecology, movement, resources, and recurring hazards; list only recurrent threats, not generic fauna catalogs.
...
Coverage (delta to region)
- Climate and terrain patterns shaping travel.
- Signature flora/fauna roles (keystone species, canopy/ground strata) without exhaustive lists.
- Reliable resources and their extraction practices.
- Recurring hazards and standard mitigations.

Canon and safety
- Do not state realm/region governance or politics here; focus on environmental realities.
