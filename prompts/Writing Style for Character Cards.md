# Writing Style — Character Cards

Purpose
- Shapes Summary and Full Description for Beings: Character cards. Consumed by `tools/cardgen.ps1` (script/API). Do not instruct file operations.

Output scope
- Summary: 1–2 sentences naming identity, role, and significance.
- Full Description: 3–8 sentences covering affiliations, capabilities, methods, motivations, risks, and current status/location.
...
Coverage (delta to parent facts)
- Role, duties, and sphere of influence.
- Affiliations and rivalries; ties to factions/places without restating their pages.
- Recognizable appearance markers or tools (brief, functional).
- Talents or known deeds; current status and whereabouts if known.

Canon and safety
- Preserve provided facts; avoid inventing relationships or events unless authorized by the calling tool.
