# Writing Style — History Cards

Purpose
- Shapes Summary and Full Description for History cards. Consumed by `tools/cardgen.ps1` (script/API).
...
Coverage
- Background causes; key events; aftermath and legacy.
- Primary actors and affected populations.
- Anchoring dates/eras or contemporaneous events when precise dating is unknown.

Canon and safety
- Link related pages via fields; do not retell their content in full.
